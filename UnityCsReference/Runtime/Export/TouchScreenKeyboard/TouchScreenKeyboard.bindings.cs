...
// ==============================================================
// 🎯 TouchScreenKeyboard — 移动平台触屏键盘
//
// 📌 作用：
//   在 iOS/Android/UWP/Switch 等平台显示原生虚拟键盘
//
// 💡 核心 API：
//   - Open(): 打开键盘，支持 text/keyboardType/autocorrection 等参数
//   - text: 当前输入文本（可读写）
//   - active: 键盘可见/激活状态
...
//   - visible: 是否有键盘完全可见
//
// 🎯 isSupported 属性根据 RuntimePlatform 判断平台支持
// 💡 inPlaceEditingBehavior 控制外接键盘时的触屏键盘行为
// ⚠️ 带 [NativeConditional("ENABLE_ONSCREEN_KEYBOARD")] 条件编译
// ==============================================================

...
// ==============================================================
// 🎯 Caching — AssetBundle 缓存管理
//
// 📌 作用：
//   管理 AssetBundle 下载后的本地缓存，支持多缓存区
//
// 💡 关键概念：
//   - IsVersionCached(): 检查 AssetBundle 是否已缓存
//   - ClearCache(): 清除所有缓存内容
//   - ClearCachedVersion(): 清除指定版本
//   - AddCache() / RemoveCache(): 多缓存区管理
//   - defaultCache / currentCacheForWriting: 读写缓存区
//
// 🎯 旧 API 已迁移到 Cache 结构体（空间/过期时间等）
// ⚠️ 目前主要用于 AssetBundle 下载缓存，Addressables 使用自己的缓存策略
// ==============================================================

...
// ==============================================================
// 🎯 AsyncInstantiateOperation — 异步实例化操作
//
// 📌 作用：
//   GameObject.InstantiateAsync 的异步操作封装
//
// 💡 关键功能：
//   - WaitForCompletion(): 阻塞等待所有实例化完成
//   - Cancel(): 取消正在进行的异步实例化
//   - Result: 实例化后的 Object 数组
//   - IsWaitingForSceneActivation(): 是否等待场景激活
//
// 🎯 泛型版本 AsyncInstantiateOperation<T>：
//   - 返回类型安全的 T[] 结果
//   - 支持 await（通过 GetAwaiter + Awaitable）
//   - m_Result 内部直接数组转换，零拷贝
//
// ⚠️ 支持 CancellationToken 取消
// ==============================================================

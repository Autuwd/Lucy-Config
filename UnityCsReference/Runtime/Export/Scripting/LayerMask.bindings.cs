...
// ==============================================================
// 🎯 LayerMask — 层遮罩（32 位位域）
//
// 📌 作用：
//   用于摄像机剔除、物理碰撞、光线投射的层筛选
//
// 💡 关键概念：
//   - 内部 int m_Mask，每位对应 0-31 层
//   - 隐式转换 int ↔ LayerMask，方便位运算
//   - LayerToName / NameToLayer：层编号 ↔ 层名称
//   - GetMask(params string[]): 从层名列表构建遮罩
//
// 🎯 物理碰撞矩阵通过 LayerMask 实现
// ⚠️ LayerToName 是主线程调用，ToString 在非主线程回退显示索引
// ==============================================================

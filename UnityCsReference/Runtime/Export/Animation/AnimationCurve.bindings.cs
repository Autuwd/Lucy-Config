...
// ==============================================================
// 🎯 AnimationCurve — 动画曲线，核心是 Keyframe 插值
//
// 📌 作用：
//   定义 float 值随时间变化的曲线，用于动画、动画事件、特效参数等
//
// 💡 关键概念：
//   - Keyframe: 关键帧，包含 time、value、inTangent、outTangent
//   - WeightedMode: 加权模式（None/In/Out/Both），控制切线权重
//   - preWrapMode / postWrapMode: 曲线前后范围外的循环方式
//
// ⚠️ Keyframe 是 struct，AnimationCurve 是 class（引用类型，需要手动 GC）
// 📍 内部通过 m_Ptr 持有 C++ 端 AnimationCurve 对象
// ==============================================================

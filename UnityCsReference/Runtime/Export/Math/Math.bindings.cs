...
// ==============================================================
// 🎯 Mathf / Matrix4x4 / Vector3 / Quaternion / Bounds — Unity 数学库
//
// 📌 作用：
//   提供游戏开发中常用的数学结构和函数
//
// 💡 Mathf vs System.Math 区别：
//   - Mathf 使用 float（游戏中 90% 场景），System.Math 使用 double
//   - Mathf 提供游戏专用函数（Lerp, Clamp, SmoothDamp 等）
//   - Mathf 静态方法通过 C++ 原生实现（部分有性能优势）
//
// 🎯 本文件包含的 C++ 绑定：
//   - Matrix4x4: TRS、Inverse、Transpose、投影矩阵
//   - Vector3: Slerp、RotateTowards、OrthoNormalize
//   - Quaternion: Slerp/Lerp、LookRotation、AngleAxis、FromToRotation
//   - Bounds: Contains、SqrDistance、ClosestPoint、射线相交
//   - Mathf: Gamma/Linear 转换、PerlinNoise、FloatToHalf
// ==============================================================

...
// ==============================================================
// 🎯 Gradient — 颜色渐变（用于粒子、UI、光照等）
//
// 📌 作用：
//   根据时间值（0~1）计算插值颜色，支持颜色和透明度通道
//
// 💡 关键概念：
//   - GradientColorKey: 颜色关键帧（color + time）
//   - GradientAlphaKey: 透明度关键帧（alpha + time）
//   - Evaluate(time): 在指定时间点计算插值颜色
//   - mode: Blend（平滑混合）/ Fixed（精确切换）/ PerceptualBlend（Oklab 感知混合）
//   - colorSpace: Gamma / Linear
//
// 🎯 Gradient 是 class（引用类型），内部持有 C++ 对象指针 m_Ptr
// 💡 支持 Span/ReadOnlySpan API 传入关键帧数组
// ==============================================================

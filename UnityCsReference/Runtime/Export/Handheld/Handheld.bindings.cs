...
//
// 📌 作用：
//   提供移动设备特有的 API：全屏视频播放、震动、活动指示器
//
// 💡 关键功能：
//   - PlayFullScreenMovie(): 播放全屏视频（已过时，建议用 VideoPlayer）
//   - Vibrate(): 触发设备震动
//   - SetActivityIndicatorStyle(): 设置加载指示器样式
//   - StartActivityIndicator() / StopActivityIndicator(): 控制指示器显隐
//
// ⚠️ PlayFullScreenMovie 在大多数现代平台已废弃
// 💡 枚举 FullScreenMovieControlMode/ScalingMode 控制视频播放行为
// ==============================================================

...
namespace UnityEngine
{
    ...
    {
        /// <summary>Unity 支持的物理引擎特性标记（内部使用）。</summary>
        [Flags]
        ...
        /// <summary>是否为回退引擎（当默认引擎不可用时）。</summary>
    ...
    // Physics 静态类
    //=============================================================================
    // Unity 3D 物理系统的核心 API 入口。
    // 底层基于 NVIDIA PhysX 物理引擎（https://github.com/NVIDIAGameWorks/PhysX）。
    //
    // 主要功能：
    //   - 射线/形状投射检测（Raycast, SphereCast, BoxCast, CapsuleCast）
    //   - 重叠检测（OverlapSphere, OverlapBox, OverlapCapsule，即 Check 方法）
    //   - 碰撞忽略与层管理（IgnoreCollision, IgnoreLayerCollision）
    //   - 穿透计算（ComputePenetration）
    //   - 全局物理参数（重力、迭代次数、接触偏移等）
    //   - 手动物理仿真（Simulate）
    //
    // 注意：所有公开方法的实现都委托给 PhysicsScene 结构体，支持多物理场景。
    //=============================================================================
    ...
    public partial class Physics
    {
        ...
        /// <summary>忽略射线层（第 2 层），用于忽略某些对象的射线检测。</summary>
        public const int IgnoreRaycastLayer = 1 << 2;

        /// <summary>默认射线层掩码，排除 IgnoreRaycastLayer 的所有层。</summary>
        public const int DefaultRaycastLayers = ~IgnoreRaycastLayer;

        /// <summary>所有层的掩码（-1，即所有位为 1）。</summary>
        ...
        /// <summary>获取所有已注册物理引擎集成的信息列表（内部使用）。</summary>
        ...
        /// <param name="ignore">是否忽略碰撞（默认 true）</param>
        ...
        /// </summary>
        /// <param name="layer1">第一个层的索引（0-31）</param>
        /// <param name="layer2">第二个层的索引（0-31）</param>
        /// <param name="ignore">是否忽略碰撞（默认 true）</param>
        ...
        //   layerMask - 层掩码，用于过滤检测（默认 DefaultRaycastLayers，排除 IgnoreRaycastLayer）
        ...
        /// <summary>使用 Ray 结构体发射射线。</summary>
        ...
        /// <summary>使用 Ray 结构体发射射线并获取碰撞信息。</summary>
        ...
        /// <summary>胶囊体投射并获取详细碰撞信息。</summary>
        ...
        // 常用于子弹检测、角色碰撞检测等。
        //
        // 注意：SphereCast 与 OverlapSphere 不同：
        //   - SphereCast：球体沿方向运动，检测路径上的物体
        //   - OverlapSphere：球体在固定位置，检测重叠的物体
        //=============================================================================

        /// <summary>用球体沿指定方向扫描，检测并获取碰撞信息。</summary>
        ...
        /// <summary>使用 Ray 和半径进行球体投射（简单检测）。</summary>
        ...
        /// <summary>使用 Ray 和半径进行球体投射（获取碰撞信息）。</summary>
        ...
        /// <summary>用盒子沿指定方向扫描（简单检测）。</summary>
        ...
        /// <summary>用盒子沿指定方向扫描并获取碰撞信息。</summary>
        ...
        ///   注意：此方法会产生 GC 分配（分配 RaycastHit[] 数组），
        ...
        /// <summary>使用 Ray 结构体的多物体射线检测。</summary>
        ...
        /// <summary>使用 Vector3 参数的 NonAlloc 射线检测。</summary>
        ...
        /// <summary>胶囊体投射，返回路径上所有碰撞器（产生 GC 分配）。</summary>
        ...
        /// <summary>球体投射，返回路径上所有碰撞器（产生 GC 分配）。</summary>
        ...
        /// <summary>使用 Ray 参数的球体多物体检测。</summary>
        ...
        /// <summary>布料（Cloth）使用的独立重力向量。</summary>
        ...
        /// <summary>检测指定位置的球体是否与任何碰撞器重叠（仅返回 bool，不获取碰撞器）。</summary>
        ...
        /// <summary>无分配胶囊体投射——将结果填充到提供的数组中。</summary>
        ...
        /// <summary>无分配球体投射——将结果填充到提供的数组中。</summary>
        ...
        /// <summary>使用 Ray 参数的无分配球体投射。</summary>
        ...
        /// <summary>检测指定位置的胶囊体是否与任何碰撞器重叠。</summary>
        ...
        /// <summary>检测指定位置的盒子与哪些碰撞器重叠（产生 GC 分配）。</summary>
        ...
        /// <summary>无分配盒子投射——将结果填充到提供的数组中。</summary>
        ...
        /// <summary>盒子投射，返回路径上所有碰撞器（产生 GC 分配）。</summary>
        ...
        /// <summary>烘焙网格数据用于 MeshCollider（使用默认烹饪选项）。</summary>
        ...
        /// <summary>通过 EntityId 获取碰撞器实例（内部使用）。</summary>
        [StaticAccessor("PhysicsManager", StaticAccessorType.DoubleColon)]
        extern internal static Collider GetColliderByInstanceID(EntityId entityId);

        /// <summary>通过 EntityId 获取物理体（Rigidbody/ArticulationBody）组件（内部使用）。</summary>
        [StaticAccessor("PhysicsManager", StaticAccessorType.DoubleColon)]
        internal static extern Component GetBodyByInstanceID(EntityId entityId);

        /// <summary>将 PhysX 内部的三角形索引转换为 Unity 的三角形索引（线程安全）。</summary>
        [NativeMethod(IsThreadSafe = true)]
        [StaticAccessor("PhysicsManager", StaticAccessorType.DoubleColon)]

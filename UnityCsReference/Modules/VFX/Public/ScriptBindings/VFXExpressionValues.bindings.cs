...
{
    // ================================================================
    // VFXExpressionValues —— VFX 表达式值查询器
    //
    // 🎯 在 SpawnerCallback 中读取 VFX Graph 表达式的运行时计算结果
    // 💡 VFXSpawnerCallbacks 的 OnPlay/OnUpdate/OnStop 通过此参数
    //    访问 VFX Graph 中定义的 exposed 表达式值
    // 📌 只读接口：GetBool/GetInt/GetFloat/GetVector2~4/GetMatrix4x4
    //             GetTexture/GetMesh/GetAnimationCurve/GetGradient
    // ⚡ 内部通过 BindingsMarshaller 将 IntPtr 转换为托管对象
    // ================================================================
